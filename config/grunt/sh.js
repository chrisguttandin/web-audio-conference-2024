    ...
    return {
        ...
        'lint-src': {
            cmd: `htmlhint --config config/htmlhint/document.json 'src/**/index.html' && \
                ...
                npx ng lint web-audio-conference-2024 && \
                npx stylelint 'src/**/*.scss' --config config/stylelint/config.json`
        },
        'lint-test': {
            cmd: 'npx ng lint web-audio-conference-2024 --configuration test'
        },
        'monitor': {
            cmd: 'npx ng serve'
        },
        ...
        'smoke': {
            cmd: `npx playwright install --with-deps && \
                ...
                npx hint --telemetry=off https://chrisguttandin.github.io/web-audio-conference-2024`
        },
        'test': {
